...
output "subnet_address_prefixes" {
  ...
  value       = flatten(concat([for s in azurerm_subnet.snet : s.address_prefixes], [var.bastion_subnet_address_prefix != null ? azurerm_subnet.bs_snet.0.address_prefixes : null], [var.gateway_subnet_address_prefix != null ? azurerm_subnet.gw_snet.0.address_prefixes : null], [var.firewall_subnet_address_prefix != null ? azurerm_subnet.fw-snet.0.address_prefixes : null]))
}
